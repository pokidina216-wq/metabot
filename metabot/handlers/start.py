    ...
    **data,
    ...
    if is_new_user:
        caption = (
            ...
            "◈ <b>VEXIS</b> — платформа цифровой разведки\n"
            "и анализа данных нового поколения.\n\n"
            "▸ 🔎 <b>OSINT</b> — поиск по 30+ источникам\n"
            "▸ 📂 <b>Метаданные</b> — анализ любых файлов\n"
            "▸ 🔤 <b>Username</b> — поиск свободных ников\n"
            "▸ 🛡 <b>Приватность</b> — защита данных\n\n"
            "┌─────────────────────┐\n"
